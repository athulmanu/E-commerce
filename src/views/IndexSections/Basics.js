...
export default function Basics() {
  const [showContent, setShowContent] = useState(false); // Set to false to hide initially
  ...
  }, [showContent]); // Run effect only when showContent changes

  return (
    <>
      <Button color="primary" onClick={() => setShowContent(!showContent)}>
        Toggle Content
      </Button>
      {showContent && ( // Conditionally render based on showContent state
          ...
          <Container>
            ...
            <Row>
              <Col md="12">
                ...
                <Button className="btn-neutral" color="default">Neutral</Button>
              </Col>
            </Row>
            <br />
            <h3>Links</h3>
            <Row>
              <Col md="8">
                ...
                <Button className="btn-link" color="primary">Primary</Button>
                <Button className="btn-link" color="info">Info</Button>
                <Button className="btn-link" color="success">Success</Button>
                <Button className="btn-link" color="warning">Warning</Button>
                <Button className="btn-link" color="danger">Danger</Button>
              </Col>
            </Row>
            ...
            <div id="inputs">
              ...
              <Row>
                ...
                <Col lg="3" sm="6">
                  <InputGroup className={classnames({ "input-group-focus": inputFocus })}>
